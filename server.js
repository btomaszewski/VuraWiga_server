...
var SampleApp = function() {
    ...
    self.createRoutes = function() {
        ...
        self.routes['/getThread/:id'] = function (request, response) {
            discuss.getPost(request.params.id, 'threads', request, response);
        };

        self.routes['/getComments/:id'] = function (request, response) {
            discuss.getPost(request.params.id, 'comments', request, response);
        };

        self.routes['/getAllThreads'] = function (request, response) {
    ...
    self.initializeServer = function() {
        ...
        self.app.post('/newThread', function (request, response) {
            discuss.newThread(request.body.author, request.body.title, request.body.body, request, response);
        });

        self.app.post('/newComment', function (request, response) {
